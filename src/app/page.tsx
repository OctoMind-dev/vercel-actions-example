...
export default function Home() {
    ...
    return (
        <main className="flex min-h-screen flex-col items-center justify-center p-24 gap-10 bg-[#13142b]">
            <span>Hello World by <a href="https://octomind.dev"
                                    className="font-medium text-blue-600 dark:text-blue-500 hover:underline">Octomind</a></span>
            <p>Fetching:{!fetchResult ?
                <div role="status">
